...
export default function ResetPasswordPage() {
    ...
    return (
      <section className="min-h-screen bg-pink-100 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg z-40 mx-4">
          <h1 className="text-3xl font-bold text-pink-400 text-center mb-4 uppercase">Reset Password</h1>
          {message && (
  ...
  return (
    <section className="min-h-screen bg-pink-100 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg z-40 mx-4">
        <h1 className="text-3xl font-bold text-pink-400 text-center mb-2 uppercase">Set new password</h1>
