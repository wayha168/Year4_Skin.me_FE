  ...
  return (
    <>
      ...
      {(() => {
        ...
        return (
      <div ref={aboutRef} id="aboutus" className={`pt-[5rem] pb-20 px-8 text-center ${noAnimation ? '' : 'transition-all duration-1000 ease-out delay-300'} ${finalVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-32'}`}>
